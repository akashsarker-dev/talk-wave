    ...
    <div className='flex'>
      <div className='w-1/2 mt-[100px] ml-[147px]'>
        ...
        <div class="relative mt-14">
          <input onChange={handlePassword} type={!passwordShow ? 'text' : 'password'} id="password" class="font-nunito pt-[26px]   border-b-2  bg-transparent text-xl font-semibold border-1 border-[rgba(17,23,93,0.3)] w-[368px] focus:outline-none peer " placeholder=" " />
          ...
          ">Password</label>
          {
            passwordShow ? <AiOutlineEyeInvisible onClick={()=> setPasswordShow(!passwordShow)} className='absolute top-6 left-[340px]'/>:
