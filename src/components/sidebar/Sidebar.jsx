...
const Sidebar = () => {
  ...
  return (
    <div>
        ...
        <button  onClick={()=> setOpen(!open)} class="inline-flex z-50  items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 ">
        ...
        <div class="h-full px-3 py-4 overflow-y-auto w-[186px] bg-primary-color">
            <div class="flex items-center justify-between sm:justify-center">
                ...
                <div onClick={handleProfileUpload} className='absolute w-full h-full top-0 left-0 flex justify-center items-center rounded-full opacity-0 group-hover:opacity-100 group-hover:bg-[rgba(0,0,0,0.41)]'>
            ...
            </ul>
            {
                ...
                <div className='absolute top-0 left-0 bg-[#0000006b] h-full w-screen flex justify-center items-center'>
                    <div className=' bg-primary-color w-1/2 p-10 rounded-md'>
                        <h2 className='text-center text-[34px] font-bold font-opensans text-white'>Upload You Image</h2>
                            ...
                            
                        {
                            ...
                            :
                            <img src={ProfilePic} className='sm:w-auto w-16 mx-auto'  alt="Logo" />

                        }
                        </div>
                        

                        <input onChange={handleUploadChange} className='mb-5 p-4 ' type="file"  />
                        {
                            image &&
                            <Cropper
                            ref={cropperRef}
                        ...
                        <div>
                        <button className='bg-sky-500 rounded-lg p-4 text-white  mt-14   text-xl font-semibold nunito cursor-pointer'>Upload</button>

                        <button onClick={handleCropCancle} className='bg-red-500 rounded-lg p-4 text-white  mt-14 ml-5  text-xl font-semibold nunito cursor-pointer'>Cancle</button>
                        </div>
                    </div>
                </div>
            }
